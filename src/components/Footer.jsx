    ...
    <div className="w-full h-screen flex flex-col justify-around items-center">
      ...
      <div className="w-[80%] h-fit flex justify-center flex-col items-center">
        ...
        >
          ...
          >Alexandre Delaboneta.</span>
        </span>
        <Link className="bg-t-white rounded-md p-2 flex justify-around items-center w-[110px] mt-4" to={'https://github.com/imxandx'} target='_blank'>
